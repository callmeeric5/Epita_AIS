...
parser.add_argument(
    "--job", type=str, required=True, help="the job name you want to select"
)
parser.add_argument(
    "--job-args",
    action="append",
    type=str,
    help='the arguments of the job passed\
...
spark = (
    SparkSession.builder.master("yarn").appName("dataproc-python-demo").getOrCreate()
)
